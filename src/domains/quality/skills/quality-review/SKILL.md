...
- 若环境支持 subagent，优先调用 [src/domains/quality/agents/quality-code-reviewer.md](/Users/xxih/workspace/my-ai-harness/src/domains/quality/agents/quality-code-reviewer.md) 执行独立评审
